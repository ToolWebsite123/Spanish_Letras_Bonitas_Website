...
const navPills: NavPill[] = [
  ...
  { label: "FF Femenino", href: "/nicks-para-juegos/nick-free-fire-femenino", icon: "👑" },
  { label: "FF Masculino", href: "/nicks-para-juegos/nick-free-fire-masculino", icon: "⚔️" },
  { label: "Cambiar Nick FF", href: "/nicks-para-juegos/cambiar-nick-free-fire", icon: "🔄" },
  { label: "Bio Colorida FF", href: "/nicks-para-juegos/bio-colorida-free-fire", icon: "🌈" },
