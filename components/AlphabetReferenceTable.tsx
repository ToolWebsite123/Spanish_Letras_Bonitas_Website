      ...
      <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-9 gap-2.5 pt-2">
        {ALPHABET.map((letter) => {
          ...
          return (
            <div
              key={letter}
              className="p-3 rounded-xl border border-purple-900/40 bg-[#231c3d] flex flex-col items-center justify-center gap-1 text-center hover:border-teal-400/60 transition-colors"
            >
