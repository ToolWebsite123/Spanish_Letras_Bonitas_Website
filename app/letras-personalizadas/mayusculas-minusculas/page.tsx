...
export const metadata: Metadata = {
  title: "Mayúsculas a Minúsculas - Convertidor de Texto 🔤",
  description:
    "Convierte texto de mayúsculas a minúsculas, formato título o alternado de forma instantánea.",
  alternates: {
...
const faqs = [
  {
    q: "¿Cómo transformar mayúsculas a minúsculas?",
    a: "Pega tu texto en el recuadro superior y obtén al instante las variaciones en minúsculas, mayúsculas y fuentes estéticas.",
  },
];
      ...
      <main className="flex-1 py-8 sm:py-12 px-4 sm:px-8 w-full max-w-5xl mx-auto flex flex-col gap-10">
        ...
        <header className="flex flex-col gap-3">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black tracking-tight bg-gradient-to-r from-teal-600 via-cyan-600 to-indigo-600 dark:from-teal-400 dark:via-cyan-300 dark:to-indigo-400 bg-clip-text text-transparent leading-tight">
            Mayúsculas a Minúsculas: Convertidor de Texto
          </h1>
        </header>
