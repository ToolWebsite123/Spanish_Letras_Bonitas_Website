...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/nicks-para-juegos/nombres-para-roblox",
  },
};
  ...
  return (
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)] transition-colors flex flex-col">
      ...
      <main className="flex-1 py-8 sm:py-12 px-4 sm:px-8 w-full max-w-5xl mx-auto flex flex-col gap-10 sm:gap-14">
        ...
        <Converter showCategoryNav={true} highlightStyleId="small" highlightStyleIds={["small", "bubble", "circled-negative", "squared", "parenthesized", "double-struck"]} />
